...
const byte pitchIndexWhite[7] PROGMEM = { 0, 2, 4, 5, 7, 9, 11 };
const byte pitchIndexBlack[5] PROGMEM = { 1, 3, 6, 8, 10 };

const byte ENC_BUTTONS_PIN = BUTTONS_ENCODER;
const byte ENC_BUTTONS_TOTAL = 3;
const int ENC_BUTTONS_VALUES[ENC_BUTTONS_TOTAL] PROGMEM = {0, 340, 511};
...
const int FUNC_BUTTONS_VALUES[FUNC_BUTTONS_TOTAL] PROGMEM = {0, 339, 510, 613, 682};
...
const int KBDB_BUTTONS_VALUES[KBDB_BUTTONS_TOTAL] PROGMEM = {0, 236, 384, 486, 560};
...
const int KBDW_BUTTONS_VALUES[KBDW_BUTTONS_TOTAL] PROGMEM = {0, 236, 384, 486, 560, 616, 660};
